...
def main():
    if len(st.session_state) == 0:
        st.session_state["messages"] = []
        # os.environ["OPENAI_API_KEY"] = "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"
        st.session_state["OPENAI_API_KEY"] = "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"
